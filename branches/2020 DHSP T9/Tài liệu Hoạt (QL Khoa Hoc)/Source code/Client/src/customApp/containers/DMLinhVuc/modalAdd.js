...
const { Item } = Form;
const { ITEM_LAYOUT3, REQUIRED} = Constants;
      ...
      return (
        ...
        >
          <ValidatorForm ref="form" onSubmit={this.handleSubmit}>
            ...
            <div>
              <Item label={<span>Mã lĩnh vực <span style={{color:'red'}}>*</span></span>}{...ITEM_LAYOUT3}>
                <GoInput
                  onChange={(event) => {
                    const { editNode } = this.state;
              ...
              <Item label={<span>Tên lĩnh vực <span style={{color:'red'}}>*</span></span>} {...ITEM_LAYOUT3}>
                <GoInput
                  onChange={(event) => {
                    const { editNode } = this.state;
