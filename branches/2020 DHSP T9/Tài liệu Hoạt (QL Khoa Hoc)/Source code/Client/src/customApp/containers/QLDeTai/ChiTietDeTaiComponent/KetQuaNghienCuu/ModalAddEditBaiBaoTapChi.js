...
class Dialog extends Component {
  ...
  render() {
    ...
    console.log(loading);
    const { DanhSachNhiemVu, ListTacGia, LoaiBaiBao, confirmLoading } = this.state;
    ...
    return (
      <Modal
        ...
        footer={[
          ...
          <Button key="submit" htmlType="submit" type="primary" form="formtapchi" onClick={this.onOk} loading={confirmLoading} disabled={confirmLoading}>
            Lưu
          </Button>,
        ]}
      >
...
export const ModalAddEditBaiBaoTapChi = Form.create({ name: "modal_add_edit" })(Dialog);
