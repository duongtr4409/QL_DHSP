      ...
      return (
        <Modal
          ...
          footer={[
            ...
            <Button key="submit" htmlType="submit" type="primary" form="formspdaotao" onClick={this.onOk} loading={loading} disabled={loading}>
              Lưu
            </Button>,
          ]}
        >
          <Form id="formspdaotao">
            ...
            <Item label={"Họ tên"} {...ITEM_LAYOUT2}>
              {getFieldDecorator("TenHocVien", {
                initialValue: dataEdit.TenHocVien ? dataEdit.TenHocVien : "",
                rules: [{ ...REQUIRED }],
              })(<Input maxLength={500} />)}
            </Item>
            <Row>
            ...
            <Item label={"Tên khóa luận/ luận văn/ luận án"} {...ITEM_LAYOUT2}>
              {getFieldDecorator("TenLuanVan", {
                initialValue: dataEdit.TenLuanVan ? dataEdit.TenLuanVan : "",
                rules: [{ ...REQUIRED }],
              })(<Input maxLength={500} />)}
            </Item>
            <Row>
              ...
              <Col {...COL_ITEM_LAYOUT_HALF2}>
                <Item label={"Năm bảo vệ"} {...ITEM_LAYOUT_HALF2}>
                  {getFieldDecorator("NamBaoVe", {
                    initialValue: dataEdit.NamBaoVe ? dataEdit.NamBaoVe : "",
                    rules: [{ ...REQUIRED }],
                  })(<InputNumber />)}
                </Item>
              </Col>
