$(function () {
    ...
    $("select").each(function () {
        $(this).change(function () {
            $("select[parent=" + $(this).attr("id") + "] option").hide();
            $("select[parent=" + $(this).attr("id") + "] option[parentId=0]").show();
            $("select[parent=" + $(this).attr("id") + "] option[parentId='" + $(this).val() + "']").show();
            $("select[parent=" + $(this).attr("id") + "]").val(0);
        });
        if ($(this).attr("value") !== undefined && $(this).attr("value") !== "" && $(this).attr("value") !== "0" && $(this).children("option[value=" + $(this).attr("value") + "]").length > 0) {
