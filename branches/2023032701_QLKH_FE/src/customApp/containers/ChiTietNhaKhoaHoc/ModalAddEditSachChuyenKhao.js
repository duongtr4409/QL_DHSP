      ...
      return (
        <Modal
          ...
          footer={[
            ...
            <Button key="submit" htmlType="submit" type="primary" form="formsach"
        ...
        >
          <Form id="formsach">
            ...
            {getFieldDecorator('LoaiThongTin', {initialValue: LoaiThongTinNhaKhoaHoc.SachChuyenKhao})}
              ...
              <Col {...COL_ITEM_LAYOUT_HALF2}>
                <Item label={"Tên sách"} {...ITEM_LAYOUT_HALF2}>
                  {getFieldDecorator('TenTapChiSachHoiThao', {
                    initialValue: dataEdit.TenTapChiSachHoiThao ? dataEdit.TenTapChiSachHoiThao : "", rules: [{...REQUIRED}]
                  })(<Input maxLength={500}/>)}
                </Item>
              </Col>
              <Col {...COL_ITEM_LAYOUT_HALF2}>
