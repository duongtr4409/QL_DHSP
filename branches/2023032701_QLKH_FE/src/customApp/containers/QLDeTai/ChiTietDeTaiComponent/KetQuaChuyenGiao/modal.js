...
class GoModal extends React.Component {
  ...
  handleOk = () => {
    ...
    api.chinhSuaThongTinChiTiet(newData).then((res) => {
      if (!res || !res.data || res.data.Status !== 1) {
        ...
        formData.append("NoiDung", JSON.stringify({ LoaiFile: 9, NghiepVuID: res.data.Data, NoiDung: this.state.data.NoiDungDaLam }));
  ...
  render() {
    ...
    return (
      <Modal confirmLoading={confirmLoading} width={960} title={"Kết quả chuyển giao đề tài"} visible={true} onOk={this.handleOk} onCancel={this.handleCancel} cancelText="Huỷ" okText="Lưu">
            ...
            <div className="col-12 my-1  ">
              <div className="row align-items-center">
                ...
                <div className="col-lg-10 ">
                  <TextArea value={data.NoiDungChuyenGiao} onChange={this.handleInputChange("NoiDungChuyenGiao")} placeholder="" allowClear />
                </div>
              </div>
            </div>
