...
const ModalAddEditKetQuaNghienCuu = Form.create({ name: "modal_add_edit" })(
  class extends Component {
    ...
    render() {
      ...
      const { DanhSachNhiemVu, ListTacGia, confirmLoading } = this.state;
      ...
      return (
        <Modal
          ...
          footer={[
            ...
            <Button key="submit" htmlType="submit" type="primary" form="formketqua" onClick={this.onOk} loading={confirmLoading} disabled={confirmLoading}>
              Lưu
            </Button>,
          ]}
        >
