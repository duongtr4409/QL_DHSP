...
namespace QLSDH.API.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        DbSet<Tbl_Entity> _dbSet;
        private TEMIS_systemEntities _DBEntity;

        public GenericRepository(TEMIS_systemEntities DBEntity)
        {
            _DBEntity = DBEntity;
        ...
        public void Update(Tbl_Entity entity)
        {
            ...
            if (_DBEntity.Entry(entity).State == EntityState.Modified)
            {
                _DBEntity.Entry(entity).State = EntityState.Added;
                _DBEntity.Entry(entity).State = EntityState.Modified;
            }
            _DBEntity.Entry(entity).State = EntityState.Modified;
        }
        public void DeAttach(Tbl_Entity entity)
        {
